...
export interface UserDetailDialogProps {
    ...
    setOpenMemberBox: (open: boolean) => void // eslint-disable-line no-unused-vars
}
        ...
        <DialogContentText>
          <div className='flex items-center gap-2'>
            ...
            <button
              ...
              onClick={() => handleExpandMember(userDetails?.membership ? userDetails.membership.membership_id: '')}
            >
              <KeyboardArrowDown
